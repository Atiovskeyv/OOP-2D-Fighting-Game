...
{
    /// <summary>
    /// Soldier Boy — Geçici karakter sınıfı (test amaçlı).
    /// </summary>
    public class SoldierBoy : AbstractCharacter
    {
        [Header("SoldierBoy Skills")]
        ...
        public override void Skill1()
        {
            ...
            Debug.Log("[SoldierBoy] Skill1 (Placeholder)");
        }
